...
from .models import User, Patient, Relationship, Direction, Disability_card, Forum_entry, Forum_response, Therapy_live, Therapy_local, Tip, Therapeutic_center, Directory
